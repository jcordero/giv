...
class grupo_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ccircuitos")->GetField("cir_semanas")->SetDisplayValues(Array("Name"=>"cir_semanas", "Label"=>"Semanas de Monitoreo", "Type"=>"int", "IsForDB"=>true, "Order"=>103, "IsMandatory"=>true, "Presentation"=>"INT", "IsVisible"=>true, "Class"=>"ccircuitos"));
        $this->getClass("ccircuitos")->GetField("cir_date_ini")->SetDisplayValues(Array("Name"=>"cir_date_ini", "Label"=>"Fecha Inicio", "Type"=>"datetime", "IsForDB"=>true, "Order"=>104, "IsMandatory"=>true, "Presentation"=>"DATE", "IsVisible"=>true, "Class"=>"ccircuitos"));
        ...
        $this->getClass("ccircuitos")->GetField("cir_importance_min")->SetDisplayValues(Array("Name"=>"cir_importance_min", "Label"=>"Importancia Min", "Type"=>"int", "IsForDB"=>true, "Order"=>106, "IsMandatory"=>true, "Presentation"=>"INT", "IsVisible"=>true, "Class"=>"ccircuitos"));
        $this->getClass("ccircuitos")->GetField("cir_status")->SetDisplayValues(Array("Name"=>"cir_status", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>107, "Presentation"=>"ESTADO_CIRCUITOS", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccircuitos", "InitialValue"=>"PENDIENTE"));
    }
}
}
