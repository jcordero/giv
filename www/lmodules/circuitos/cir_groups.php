...
class ccir_groups_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('cir_code','cirg_code','use_code_supervisor');

        $this->addAction(4,"cir_groups_v_maint.php?OP=V",array(new caction_param('cirg_code')),"","ver","V","","");
        $this->addAction(4,"cir_groups_maint.php?OP=M",array(new caction_param('cirg_code')),"","modificar","M","circuitos.cir_groups.actualizar","");
        $this->addAction(4,"cir_groups_maint.php?OP=B",array(new caction_param('cirg_code')),"","eliminar","B","circuitos.cir_groups.actualizar","");
        $this->addAction(4,"cir_groups_oper.php?OP=L",array(new caction_param('cirg_code')),"","operadores","L","circuitos.cir_groups","");
    }
