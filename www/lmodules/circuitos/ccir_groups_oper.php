...
class ccir_groups_oper extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['cirg_cant_mon_pendientes'] = new CField(Array("Name"=>"cirg_cant_mon_pendientes", "Type"=>"int", "IsForDB"=>true, "Order"=>105, "total"=>true));
        $this->m_fields['cirg_cant_mon_realizados'] = new CField(Array("Name"=>"cirg_cant_mon_realizados", "Type"=>"int", "IsForDB"=>true, "Order"=>106, "total"=>true));
        $this->m_fields['cirg_cant_mon_ok'] = new CField(Array("Name"=>"cirg_cant_mon_ok", "Type"=>"int", "IsForDB"=>true, "Order"=>107, "total"=>true));
        $this->m_fields['cirg_cant_mon_mal'] = new CField(Array("Name"=>"cirg_cant_mon_mal", "Type"=>"int", "IsForDB"=>true, "Order"=>108, "total"=>true));
        $this->m_fields['cirg_cant_cap_pendientes'] = new CField(Array("Name"=>"cirg_cant_cap_pendientes", "Type"=>"int", "IsForDB"=>true, "Order"=>109, "total"=>true));
        $this->m_fields['cirg_cant_cap_realizados'] = new CField(Array("Name"=>"cirg_cant_cap_realizados", "Type"=>"int", "IsForDB"=>true, "Order"=>110, "total"=>true));
        $this->m_fields['cirg_cant_cap_ok'] = new CField(Array("Name"=>"cirg_cant_cap_ok", "Type"=>"int", "IsForDB"=>true, "Order"=>111, "total"=>true));
        $this->m_fields['cirg_cant_cap_mal'] = new CField(Array("Name"=>"cirg_cant_cap_mal", "Type"=>"int", "IsForDB"=>true, "Order"=>112, "total"=>true));
