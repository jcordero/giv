...
class ccir_groups_oper extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_savedb_insert_sql = "INSERT INTO cir_groups_oper(cirg_code, cir_code, use_code_operador, crit_status_ini, crit_status_fin, cirg_cant_mon_pendientes, cirg_cant_mon_realizados, cirg_cant_mon_ok, cirg_cant_mon_mal, cirg_cant_cap_pendientes, cirg_cant_cap_realizados, cirg_cant_cap_ok, cirg_cant_cap_mal, cirg_cant_mon_cierre_forz) VALUES (:cirg_code:, :cir_code:, :use_code_operador:, :crit_status_ini:, :crit_status_fin:, :cirg_cant_mon_pendientes:, :cirg_cant_mon_realizados:, :cirg_cant_mon_ok:, :cirg_cant_mon_mal:, :cirg_cant_cap_pendientes:, :cirg_cant_cap_realizados:, :cirg_cant_cap_ok:, :cirg_cant_cap_mal:, :cirg_cant_mon_cierre_forz:)";
