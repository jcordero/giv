...
if( !class_exists('grupo1_gr') ) {
class grupo1_gr extends cform_group {
    function __construct($parent) {
        parent::__construct($parent);
        $this->m_title = 'Seleccione el Grupo'; //Titulo del grupo
        $this->m_order = 1; //Orden de presentacion de este grupo
        $this->m_id = 'grupo1'; //Id para los wizards
        $this->m_note = ''; //Nota
        $this->m_image = ''; //Imagen
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ccir_groups_n")->GetField("oper_grupo")->SetDisplayValues(Array("Name"=>"oper_grupo", "Label"=>"Grupo", "Size"=>20, "IsForDB"=>true, "Order"=>104, "IsMandatory"=>true, "ValueList"=>"oper_grupo", "Presentation"=>"SELECT", "IsNullable"=>false, "IsVisible"=>true, "Class"=>"ccir_groups_n"));
    }
}
}
...
class grupo2_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("ccir_groups_n")->GetField("cirg_code")->SetDisplayValues(Array("Name"=>"cirg_code", "Label"=>"Grupo Nro", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"SEQUENCE", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Sequence"=>"cir_groups", "ClassParams"=>"cir_groups", "Class"=>"ccir_groups_n"));
        $this->getClass("ccir_groups_n")->GetField("cir_code")->SetDisplayValues(Array("Name"=>"cir_code", "Label"=>"Circuito", "Type"=>"int", "IsForDB"=>true, "Order"=>102, "IsMandatory"=>true, "Presentation"=>"SELECTTABLE", "IsNullable"=>false, "IsVisible"=>true, "ClassParams"=>"SELECT  cir_name,cir_code FROM circuitos where cir_status in (\"PENDIENTE\",\"ACTIVO\") order by cir_name", "Class"=>"ccir_groups_n"));
...
class ccir_groups_n_m extends cclass_maint {
    function __construct() {
		...
		$this->m_this_page = 'cir_groups_n_maint.php';
    	$this->m_save_to_type = 'DB'; //Si el formulario accede directo a las tablas o hace una transaccion
    	$this->m_view = ''; //Si se presenta como sabana o como wizard
    	$this->m_operation_allow = 'VNMPSDB'; //Lista de operaciones permitidas
    	$this->m_operation_default = 'V'; //Operacion por defecto
    	$this->m_title = 'Nueva Asignación de Grupos a Circuitos';// Titulo del formulario
    	$this->m_comment = '';// Comentario del formulario
        ...
        //Acciones
		$this->m_action[] = new CAction('N','Asignar Grupo de Operadores','','','cir_groups_n_maint.php?OP=N','cir_code|oper_grupo|','','');

        //Grupos
		$this->m_handler[1] = new grupo1_gr($this);
    ...
    function RenderJSIncludes() {
        $html = '';
        $html.="<script type='text/javascript' src='/common/presentation/generic.js'></script>";
        $html.="<script type='text/javascript' src='buscar_grupo.js'></script>";
