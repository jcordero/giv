...
class ccapacitacion_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_page_name = "capacitacion_oper_pend.php";
        ...
        $this->m_search_fields = array('cap_code','mon_code','cir_code','use_code_operador','use_code_supervisor','cap_status','cap_visto_oper');

        $this->addAction(8,"capacitacion_oper_maint.php?OP=M",array(new caction_param('cap_code')),"","dar visto","M","capacitacion.operador.pendOK","/lmodules/capacitacion/capacitacion_oper_pend.php?last=1&OP=L");
        $this->addAction(8,"/lmodules/monitoreos/monitoreos_superv_maint.php?OP=V",array(new caction_param('mon_code')),"","ver monitoreo","V","","/lmodules/capacitacion/capacitacion_oper_pend.php?last=1&OP=L");
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("cap_visto_oper")->SetDisplayValues(Array("Name"=>"cap_visto_oper", "Label"=>"Visto", "Size"=>2, "IsForDB"=>true, "Order"=>117, "Presentation"=>"TEXT", "InitialValue"=>"NO"));
    }
