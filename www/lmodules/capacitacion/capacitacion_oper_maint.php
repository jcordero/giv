...
class datos2_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ccapacitacion")->GetField("cap_use_code")->SetDisplayValues(Array("Name"=>"cap_use_code", "Label"=>"Capacitado por", "Type"=>"int", "IsForDB"=>true, "Order"=>110, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
