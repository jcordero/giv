...
class datos1_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ccapacitacion")->GetField("cap_status")->SetDisplayValues(Array("Name"=>"cap_status", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>108, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
    }
}
}
...
class datos2_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("ccapacitacion")->GetField("cap_date")->SetDisplayValues(Array("Name"=>"cap_date", "Label"=>"Fecha", "Type"=>"datetime", "IsForDB"=>true, "Order"=>107, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_use_code")->SetDisplayValues(Array("Name"=>"cap_use_code", "Label"=>"Capacitado por", "Type"=>"int", "IsForDB"=>true, "Order"=>111, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_origen")->SetDisplayValues(Array("Name"=>"cap_origen", "Label"=>"Origen", "Size"=>20, "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_motivo")->SetDisplayValues(Array("Name"=>"cap_motivo", "Label"=>"Motivo", "Size"=>200, "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>2, "Cols"=>100, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_habilidad")->SetDisplayValues(Array("Name"=>"cap_habilidad", "Label"=>"Habilidad", "Size"=>200, "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_tipo_tramite")->SetDisplayValues(Array("Name"=>"cap_tipo_tramite", "Label"=>"Tipo Trámite", "Size"=>200, "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>2, "Cols"=>100, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_rol_play_aprobado")->SetDisplayValues(Array("Name"=>"cap_rol_play_aprobado", "Label"=>"Rol Play Aprobado", "Size"=>2, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccapacitacion"));
    }
}
}
...
class datos3_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("ccapacitacion")->GetField("cap_observaciones")->SetDisplayValues(Array("Name"=>"cap_observaciones", "Label"=>"Observaciones", "Size"=>400, "IsForDB"=>true, "Order"=>116, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>4, "Cols"=>100, "Class"=>"ccapacitacion"));
    }
}
}
...
class datos4_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("ccapacitacion")->GetField("cap_visto_oper")->SetDisplayValues(Array("Name"=>"cap_visto_oper", "Label"=>"Visto", "Size"=>2, "IsForDB"=>true, "Order"=>117, "IsMandatory"=>true, "Presentation"=>"SINO", "IsVisible"=>true, "Class"=>"ccapacitacion"));
        $this->getClass("ccapacitacion")->GetField("cap_date_visto_oper")->SetDisplayValues(Array("Name"=>"cap_date_visto_oper", "Label"=>"Fecha", "Type"=>"datetime", "IsForDB"=>true, "Order"=>118, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"ccapacitacion"));
    }
}
}
