...
class datos1_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("cmonitoreos_superv")->GetField("mon_use_code")->SetDisplayValues(Array("Name"=>"mon_use_code", "Label"=>"Supervisor Monitoreo", "Type"=>"int", "IsForDB"=>true, "Order"=>121, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_date")->SetDisplayValues(Array("Name"=>"mon_date", "Label"=>"Fecha", "Type"=>"datetime", "IsForDB"=>true, "Order"=>107, "Presentation"=>"DATE", "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_status")->SetDisplayValues(Array("Name"=>"mon_status", "Label"=>"Estado Monitoreo", "Size"=>20, "IsForDB"=>true, "Order"=>108, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_note")->SetDisplayValues(Array("Name"=>"mon_note", "Label"=>"Nota", "Size"=>400, "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
    }
}
}
...
class datos3_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("cmonitoreos_superv")->GetField("mon_puntaje")->SetDisplayValues(Array("Name"=>"mon_puntaje", "Label"=>"Puntaje", "Type"=>"int", "IsForDB"=>true, "Order"=>116, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_perjuicio_cliente")->SetDisplayValues(Array("Name"=>"mon_perjuicio_cliente", "Label"=>"Req. Capacitac.", "Size"=>2, "IsForDB"=>true, "Order"=>118, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_aprobo")->SetDisplayValues(Array("Name"=>"mon_aprobo", "Label"=>"Aprobado", "Size"=>2, "IsForDB"=>true, "Order"=>117, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
...
class datos2_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("cmonitoreos_superv")->GetField("cli_call_code")->SetDisplayValues(Array("Name"=>"cli_call_code", "Label"=>"Tipo LLamado", "Size"=>200, "IsForDB"=>true, "Order"=>112, "Presentation"=>"CLI_CALL", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_call_date")->SetDisplayValues(Array("Name"=>"mon_call_date", "Label"=>"Fecha Llamada", "Type"=>"datetime", "IsForDB"=>true, "Order"=>113, "Presentation"=>"DATE", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_call_reference")->SetDisplayValues(Array("Name"=>"mon_call_reference", "Label"=>"Ref LLamado", "Size"=>20, "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("doc_storage")->SetDisplayValues(Array("Name"=>"doc_storage", "Label"=>"Archivo Call", "Size"=>200, "IsForDB"=>true, "Order"=>115, "Presentation"=>"CALLS_AUDIO", "IsVisible"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_call_llamada")->SetDisplayValues(Array("Name"=>"mon_call_llamada", "Label"=>"LLamada", "Size"=>20, "IsForDB"=>true, "Order"=>123, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_call_tel_origen")->SetDisplayValues(Array("Name"=>"mon_call_tel_origen", "Label"=>"Tel. Origen", "Size"=>40, "IsForDB"=>true, "Order"=>124, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_call_operador")->SetDisplayValues(Array("Name"=>"mon_call_operador", "Label"=>"Operador del Llamado", "Size"=>20, "IsForDB"=>true, "Order"=>125, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
    }
}
}
...
class datos4_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("cmonitoreos_superv")->GetField("mon_forzado")->SetDisplayValues(Array("Name"=>"mon_forzado", "Label"=>"Cierre Forzado ?", "Size"=>2, "IsForDB"=>true, "Order"=>109, "Presentation"=>"SINO", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
        $this->getClass("cmonitoreos_superv")->GetField("mon_motivo")->SetDisplayValues(Array("Name"=>"mon_motivo", "Label"=>"Motivo de Cierre Forzado", "Size"=>200, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"cmonitoreos_superv"));
    }
}
}
...
class mon_items_th5 extends ctable_handler {
    function __construct($parent) {
        ...
        $this->m_columns[1] = new ctable_column(1,'Item',array('mon_code','it_order','it_name','it_critico','it_importance','it_puntaje','it_perjuicio_cliente','it_code'));
        $this->m_columns[2] = new ctable_column(2,'Aprobado?',array('it_aprobo'));
        $this->m_columns[3] = new ctable_column(3,'Nota',array('it_note'));
    }
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("it_name")->SetDisplayValues(Array("Name"=>"it_name", "Label"=>"Desc", "Size"=>200, "IsForDB"=>true, "Order"=>103, "IsNullable"=>false));
