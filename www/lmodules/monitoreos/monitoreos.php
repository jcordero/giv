...
class cmonitoreos_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('mon_code','cir_code','use_code_operador','use_code_supervisor','mon_date','mon_status','cli_call_code','mon_call_reference','mon_aprobo','mon_perjuicio_cliente','mon_add_mon','mon_add_cap');
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("use_code_supervisor")->SetDisplayValues(Array("Name"=>"use_code_supervisor", "Label"=>"Supervisor", "Type"=>"int", "IsForDB"=>true, "Order"=>105, "Presentation"=>"SUPERVISOR", "IsNullable"=>false, "IsVisible"=>true));
        ...
        $this->m_obj->GetField("cli_call_code")->SetDisplayValues(Array("Name"=>"cli_call_code", "Label"=>"Tipo LLamado", "Size"=>200, "IsForDB"=>true, "Order"=>109, "Presentation"=>"CLI_CALL", "IsVisible"=>true));
        $this->m_obj->GetField("mon_call_reference")->SetDisplayValues(Array("Name"=>"mon_call_reference", "Label"=>"Ref LLamado", "Size"=>20, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true));
        $this->m_obj->GetField("mon_aprobo")->SetDisplayValues(Array("Name"=>"mon_aprobo", "Label"=>"Aprobado", "Size"=>2, "IsForDB"=>true, "Order"=>112, "Presentation"=>"SINO", "IsVisible"=>true));
        $this->m_obj->GetField("mon_perjuicio_cliente")->SetDisplayValues(Array("Name"=>"mon_perjuicio_cliente", "Label"=>"Perjuicio", "Size"=>2, "IsForDB"=>true, "Order"=>113, "Presentation"=>"SINO", "IsVisible"=>true));
        $this->m_obj->GetField("mon_add_mon")->SetDisplayValues(Array("Name"=>"mon_add_mon", "Label"=>"Agrega Monitoreos?", "Size"=>2, "IsForDB"=>true, "Order"=>114, "Presentation"=>"SINO", "IsVisible"=>true));
        $this->m_obj->GetField("mon_add_cap")->SetDisplayValues(Array("Name"=>"mon_add_cap", "Label"=>"Agrega Capacitacion", "Size"=>2, "IsForDB"=>true, "Order"=>115, "Presentation"=>"SINO", "IsVisible"=>true));
    }
...
class col105 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"use_code_supervisor", "Label"=>"Supervisor", "Type"=>"int", "IsForDB"=>true, "Order"=>105, "Presentation"=>"SUPERVISOR", "IsNullable"=>false, "IsVisible"=>true));
    }
}
...
class col109 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cli_call_code", "Label"=>"Tipo LLamado", "Size"=>200, "IsForDB"=>true, "Order"=>109, "Presentation"=>"CLI_CALL", "IsVisible"=>true));
    }
}
...
class col110 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_call_reference", "Label"=>"Ref LLamado", "Size"=>20, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT"));
    }
}
...
class col112 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_aprobo", "Label"=>"Aprobado", "Size"=>2, "IsForDB"=>true, "Order"=>112, "Presentation"=>"SINO", "IsVisible"=>true));
    }
}
...
class col111 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_puntaje", "Label"=>"Puntaje", "Type"=>"int", "IsForDB"=>true, "Order"=>111, "Presentation"=>"INT", "IsVisible"=>true));
    }
}
...
class col113 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_perjuicio_cliente", "Label"=>"Perjuicio", "Size"=>2, "IsForDB"=>true, "Order"=>113, "Presentation"=>"SINO", "IsVisible"=>true));
    }
}
...
class col114 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_add_mon", "Label"=>"Agrega Monitoreos?", "Size"=>2, "IsForDB"=>true, "Order"=>114, "Presentation"=>"SINO"));
    }
}
...
class col115 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_add_cap", "Label"=>"Agrega Capacitacion", "Size"=>2, "IsForDB"=>true, "Order"=>115, "Presentation"=>"SINO"));
    }
}
...
class col108 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"mon_note", "Label"=>"Nota", "Size"=>200, "IsForDB"=>true, "Order"=>108, "Presentation"=>"TEXT", "IsVisible"=>true));
    }
}
