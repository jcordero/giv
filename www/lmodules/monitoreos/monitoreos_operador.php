...
class cmonitoreos_rep_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('mon_code','cir_code','use_code_operador','use_code_supervisor','mon_date','mon_call_date','mon_status','mon_forzado','cli_call_code','mon_aprobo','mon_perjuicio_cliente');

        $this->addAction(12,"monitoreos_maint.php?OP=V",array(new caction_param('mon_code')),"","detalle","V","","monitoreos_operador.php?last=1&OP=L");
        $this->addAction(12,"/lmodules/capacitacion/capacitacion_oper.php?OP=L",array(new caction_param('mon_code'),new caction_param('mon_add_cap')),"","capacitacion","L","capacitacion.operador","monitoreos_operador.php?last=1&OP=L");
    }
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("use_code_operador")->SetDisplayValues(Array("Name"=>"use_code_operador", "Label"=>"Oper.", "Type"=>"int", "IsForDB"=>true, "Order"=>105, "Presentation"=>"CURRENTUSER", "IsNullable"=>false, "ClassParams"=>"force"));
...
class col105 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"use_code_operador", "Label"=>"Oper.", "Type"=>"int", "IsForDB"=>true, "Order"=>105, "Presentation"=>"CURRENTUSER", "IsNullable"=>false, "ClassParams"=>"force"));
    }
}
