...
if( !class_exists('cmon_iniciar_circuito') ) {
class cmon_iniciar_circuito extends cobjbase {

    function __construct() {
        parent::__construct();
        $this->m_classname = "cmon_iniciar_circuito";
        ...
        $this->m_fields['cir_date_ini'] = new CField(Array("Name"=>"cir_date_ini", "Type"=>"datetime", "IsForDB"=>true, "Order"=>103));
        $this->m_fields['cir_date_fin'] = new CField(Array("Name"=>"cir_date_fin", "Type"=>"datetime", "IsForDB"=>true, "Order"=>104));
        $this->m_fields['cir_importance_min'] = new CField(Array("Name"=>"cir_importance_min", "Type"=>"int", "IsForDB"=>true, "Order"=>105));
        $this->m_fields['cir_status'] = new CField(Array("Name"=>"cir_status", "Size"=>20, "IsForDB"=>true, "Order"=>106));
...
} //-- Fin clase cmon_iniciar_circuito
}
?>
