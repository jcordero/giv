...
class cmonitoreos extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_loaddb_sql = "SELECT mon_code, cir_code, cirg_code, use_code_operador, use_code_supervisor, mon_date, mon_status, mon_forzado, mon_motivo, mon_note, cli_call_code, mon_call_date, mon_call_reference, doc_storage, mon_puntaje, mon_aprobo, mon_perjuicio_cliente, mon_add_mon, mon_add_cap, mon_use_code, mon_date_aprox FROM monitoreos  WHERE mon_code= :mon_code_key:";
        $this->m_objfactory_sql = "SELECT mon_code, cir_code, cirg_code, use_code_operador, use_code_supervisor, mon_date, mon_status, mon_forzado, mon_motivo, mon_note, cli_call_code, mon_call_date, mon_call_reference, doc_storage, mon_puntaje, mon_aprobo, mon_perjuicio_cliente, mon_add_mon, mon_add_cap, mon_use_code, mon_date_aprox FROM monitoreos";
        $this->m_objfactory_suffix_sql = " ORDER BY mon_date_aprox asc";
        $this->m_savedb_update_sql = "UPDATE monitoreos SET mon_code= :mon_code:, cir_code= :cir_code:, cirg_code= :cirg_code:, use_code_operador= :use_code_operador:, use_code_supervisor= :use_code_supervisor:, mon_date= :mon_date:, mon_status= :mon_status:, mon_forzado= :mon_forzado:, mon_motivo= :mon_motivo:, mon_note= :mon_note:, cli_call_code= :cli_call_code:, mon_call_date= :mon_call_date:, mon_call_reference= :mon_call_reference:, doc_storage= :doc_storage:, mon_puntaje= :mon_puntaje:, mon_aprobo= :mon_aprobo:, mon_perjuicio_cliente= :mon_perjuicio_cliente:, mon_add_mon= :mon_add_mon:, mon_add_cap= :mon_add_cap:, mon_use_code= :mon_use_code:, mon_date_aprox= :mon_date_aprox: WHERE mon_code=:mon_code_key:";
        $this->m_savedb_insert_sql = "INSERT INTO monitoreos(mon_code, cir_code, cirg_code, use_code_operador, use_code_supervisor, mon_date, mon_status, mon_forzado, mon_motivo, mon_note, cli_call_code, mon_call_date, mon_call_reference, doc_storage, mon_puntaje, mon_aprobo, mon_perjuicio_cliente, mon_add_mon, mon_add_cap, mon_use_code, mon_date_aprox) VALUES (:mon_code:, :cir_code:, :cirg_code:, :use_code_operador:, :use_code_supervisor:, :mon_date:, :mon_status:, :mon_forzado:, :mon_motivo:, :mon_note:, :cli_call_code:, :mon_call_date:, :mon_call_reference:, :doc_storage:, :mon_puntaje:, :mon_aprobo:, :mon_perjuicio_cliente:, :mon_add_mon:, :mon_add_cap:, :mon_use_code:, :mon_date_aprox:)";
