...
include_once "cdes_circuito_group.php";

class cdes_circuito_group_sl extends csearchandlist {
    function __construct() {
        parent::__construct();
        $this->m_title = "Desempeño por Grupo de Operadores";
        $this->m_classname = "cdes_circuito_group_sl";
        $this->m_obj = new cdes_circuito_group();
        $this->m_page_name = "des_circuito_group.php";
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("cirg_code")->SetDisplayValues(Array("Name"=>"cirg_code", "Label"=>"Grupo", "Type"=>"INT", "IsForDB"=>true, "Order"=>2, "Presentation"=>"CIRG_CODE", "IsVisible"=>true));
    }
...
class col2 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_code", "Label"=>"Grupo", "Type"=>"INT", "IsForDB"=>true, "Order"=>2, "Presentation"=>"CIRG_CODE", "IsVisible"=>true));
    }
}
...
class cdes_circuito_group_table extends ctable
{
    function __construct($parent)
    {
        parent::__construct($parent);
        $this->m_title = 'Desempeño por Grupo de Operadores'; //Titulo de la tabla
        $this->m_classname = 'cdes_circuito_group'; //Clase contenedora de datos
