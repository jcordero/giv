...
include_once "cdes_circuito_oper.php";

class cdes_circuito_oper_sl extends csearchandlist {
    function __construct() {
        parent::__construct();
        $this->m_title = "Desempeño por Supervisor";
        $this->m_classname = "cdes_circuito_oper_sl";
        $this->m_obj = new cdes_circuito_oper();
        $this->m_page_name = "des_circuito_oper.php";
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("use_code_operador")->SetDisplayValues(Array("Name"=>"use_code_operador", "Label"=>"Operador", "Type"=>"INT", "IsForDB"=>true, "Order"=>2, "Presentation"=>"OPERADOR", "IsVisible"=>true));
        $this->m_obj->GetField("use_code_supervisor")->SetDisplayValues(Array("Name"=>"use_code_supervisor", "Label"=>"Supervisor Asignado", "Type"=>"INT", "IsForDB"=>true, "Order"=>3, "Presentation"=>"SUPERVISOR", "IsVisible"=>true));
    }
...
class col2 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"use_code_operador", "Label"=>"Operador", "Type"=>"INT", "IsForDB"=>true, "Order"=>2, "Presentation"=>"OPERADOR", "IsVisible"=>true));
    }
}
...
class col4 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_mon_pendientes", "Label"=>"Mon. Pend.", "Type"=>"INT", "IsForDB"=>true, "Order"=>4, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class col5 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_mon_realizados", "Label"=>"Mon. Realiz", "Type"=>"INT", "IsForDB"=>true, "Order"=>5, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class col6 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_mon_ok", "Label"=>"Mon. OK", "Type"=>"INT", "IsForDB"=>true, "Order"=>6, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class col7 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_mon_mal", "Label"=>"Mon. Mal", "Type"=>"INT", "IsForDB"=>true, "Order"=>7, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class col12 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_mon_cierre_forz", "Label"=>"Cierre Forzado", "Type"=>"INT", "IsForDB"=>true, "Order"=>12, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class col8 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_cap_pendientes", "Label"=>"Capac. Pend.", "Type"=>"INT", "IsForDB"=>true, "Order"=>8, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class col9 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"cirg_cant_cap_realizados", "Label"=>"Capac. Realiz", "Type"=>"INT", "IsForDB"=>true, "Order"=>9, "Presentation"=>"INT", "IsVisible"=>true, "total"=>true));
    }
}
...
class cdes_circuito_oper_table extends ctable
{
    function __construct($parent)
    {
        ...
        $this->m_classname = 'cdes_circuito_oper'; //Clase contenedora de datos
