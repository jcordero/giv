...
class cestado_monitoreo_sl extends csearchandlist {
    function __construct() {
        parent::__construct();
        $this->m_title = "Estado de Monitoreo";
        $this->m_classname = "cestado_monitoreo_sl";
        $this->m_obj = new cestado_monitoreo();
        $this->m_page_name = "estado_monitoreo.php";
        ...
        $this->addAction(5,"estado_monitoreo_maint.php?OP=V",array(new caction_param('id_estado_de_monitoreo')),"","ver","V","","");
        $this->addAction(5,"estado_monitoreo_maint_b.php?OP=B",array(new caction_param('id_estado_de_monitoreo')),"","baja","B","","");
        $this->addAction(5,"estado_monitoreo_maint.php?OP=M",array(new caction_param('id_estado_de_monitoreo')),"","modificar","M","","");
    }
...
class cestado_monitoreo_table extends ctable
{
    function __construct($parent)
    {
        parent::__construct($parent);
        $this->m_title = 'Estado de Monitoreo'; //Titulo de la tabla
        $this->m_classname = 'cestado_monitoreo'; //Clase contenedora de datos
