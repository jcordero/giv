...
class coper_status_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('use_code','oper_status','crit_status','oper_grupo','oper_nuevo');

        $this->addAction(6,"oper_status_maint.php?OP=V",array(new caction_param('use_code')),"","ver","V","","");
        $this->addAction(6,"oper_status_maint.php?OP=M",array(new caction_param('use_code')),"","modificar","M","","");
        $this->addAction(6,"/modules/security/users_maint.php?OP=V",array(new caction_param('use_code')),"","datos usuario","V","","");
        $this->addAction(6,"oper_status_b_maint.php?OP=M",array(new caction_param('use_code')),"","baja","M","","");
    }
    ...
    /* Campos de busqueda */
        $this->m_obj->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"OPERADOR", "IsNullable"=>false, "IsVisible"=>true));
        $this->m_obj->GetField("oper_status")->SetDisplayValues(Array("Name"=>"oper_status", "Label"=>"Estado Operador", "Size"=>10, "IsForDB"=>true, "Order"=>108, "Presentation"=>"ESTADO", "IsVisible"=>true, "InitialValue"=>"ACTIVO"));
        ...
        $this->m_obj->GetField("oper_grupo")->SetDisplayValues(Array("Name"=>"oper_grupo", "Label"=>"Grupo", "Size"=>50, "IsForDB"=>true, "Order"=>103, "ValueList"=>"oper_grupo", "Presentation"=>"SELECT", "IsNullable"=>false, "IsVisible"=>true));
...
class col101 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"OPERADOR", "IsNullable"=>false, "IsVisible"=>true));
    }
}
...
class col108 extends ccolumn
{
    function __construct($parent)
    {
        ...
        $this->m_isvisible = true;
        $this->m_align = 'left';
        $this->m_sort_field = 'oper_status';
        $this->m_width = '';

        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"oper_status", "Label"=>"Estado Operador", "Size"=>10, "IsForDB"=>true, "Order"=>108, "Presentation"=>"ESTADO", "IsVisible"=>true, "InitialValue"=>"ACTIVO"));
    }
}
...
class col103 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"oper_grupo", "Label"=>"Grupo", "Size"=>50, "IsForDB"=>true, "Order"=>103, "ValueList"=>"oper_grupo", "Presentation"=>"SELECT", "IsNullable"=>false, "IsVisible"=>true));
    }
}
